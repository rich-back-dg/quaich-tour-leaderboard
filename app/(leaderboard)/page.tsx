...
export default function Standings() {
  ...
  return (
    <div className="flex-1 flex flex-col gap-10 items-center w-full bg-sky-50">
      <div className="relative w-full h-80">
        ...
        <div className=" absolute bottom-3 left-0 my-4 ml-6 flex flex-col gap-3 w-fit">
          <h2 className="font-medium text-4xl text-white">Standings</h2>
          <div>
        ...
        <main className="flex-1 flex flex-col gap-6 w-full items-center ">
          <div className="w-full py-4 flex flex-col gap-5">
            <div className="bg-white p-4 shadow-md text-sm">
              <LucideInfo strokeWidth={2} className="w-4 h-4 mb-3 text-blue-600" />
              <p className="text-zinc-600">
                Players&apos; overall points for the Quaich Tour will be taken
                from their best 5 points finishes. Quaich Tour Majors are worth
                120% of the points of regular events. Any dropped events will be
                shown in gray below.
              </p>
            </div>
